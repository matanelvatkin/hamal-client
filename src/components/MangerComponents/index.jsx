...
export default function MangerComponents() {
  ...
  const getUsers = async () => {
    const results = await apiCalls("get", "user/allusersdev/"+user.organization);
  ...
  const adminAddUser = async (e) => {
    ...
    if (addUserRef.current.value !== "") {
      await apiCalls("post", "user/userfromdev", {
  ...
  const getPositions = async (e) => {
    const results = await apiCalls("get", "position/allpositionsdev/"+user.organization);
  ...
  const addPosition = async (e) => {
    ...
    if (addPositionNameRef.current.value !== "") {
      await apiCalls("post", "position/addpositiondev", {
